...
$unvan = $db->prepare("select * from unvan");
$unvan->execute();
                ...
                <div class="card" style="padding-left: 30px; padding-right: 30px; padding-bottom: 30px">
                    <div class="card-content">
                        <form action="../network/islem.php" method="POST">
                            <span class="card-title">Unvan Ekle</span>
                            <div class="input-field">
                                <input id="unvan" type="text" class="validate" name="unvan">
                                <label for="unvan">Unvan İsmi</label>
                            </div>
                            <div class="input-field">
                                <button class="btn waves-effect waves-light right"
                                        type="submit" name="unvan_ekle">Ekle
            ...
            <div class="col l6" id="category">
                <div class="card" style="padding-left: 30px; padding-right: 30px; padding-bottom: 30px">
                    ...
                    <div class="dd" id="nestable3">
                        <ol class="dd-list">
                            <?php
                            while ($row=$unvan->fetch(PDO::FETCH_ASSOC)) {
    ...
    function unvan_sil_cevap(val) {
        ...
        if (val) {
            swal({   title: "Silindi",
                ...
                function(){
                    window.location.href = "unvanlar.php";
                });
        } else {
