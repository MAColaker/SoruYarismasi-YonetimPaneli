...
$sorgu = $db->prepare("select * from sorular where soru_id=:soru_id");
$sorgu->execute(array(
    "soru_id" => $id
));

$soru = $sorgu->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <form class="container" action="../network/islem.php" method="POST">
                        <h4 class="header2">SORU DÜZENLE</h4>
                        <div class="switch right-align">
                            <label>
                                Pasif
                                <input id="statu" type="checkbox" name="statu"
                                       value="<?php echo $soru['statu'] ?>" <?php echo $soru['statu'] == 1 ? 'checked' : '' ?>>
                        ...
                        <div class="row">
                            <input class="hide" type="number" name="soru_id"
                                   value="<?php echo $soru['soru_id'] ?>">
                            <div class="row">
                                <div class="input-field col s12">
                                    <i class="mdi-action-help prefix"></i>
                                    <textarea id="soru" class="materialize-textarea" required=""
                                              name="soru"><?php echo $soru["soru"] ?></textarea>
                            ...
                            <div class="row">
                                <div class="col s12 m6 l6 input-field">
                                    ...
                                    <input id="cevap" type="text" required="" name="dogru_cevap"
                                           value="<?php echo $soru['dogru_cevap'] ?>">
                            ...
                            <div class="row">
                                <div class="col s12 m6 l6 input-field">
                                    ...
                                    <input id="ek1" type="text" name="ek_1" value="<?php echo $soru['ek_1'] ?>">
                                    <label for="ek1">Ek Cevap</label>
                                </div>
                                <div class="col s12 m6 l6 input-field right">
                                    <i class="mdi-image-exposure-plus-2 prefix"></i>
                                    <input id="ek2" type="text" name="ek_2" value="<?php echo $soru['ek_2'] ?>">
                                    ...
                                    <div class="input-field col s12">
                                        <div id="_seviye">
                                            <select id="seviye" name="seviye" required="">
                                                <option value="" disabled>Seviyeyi Seçin</option>
                                                <?php
                                                while ($row = $seviye->fetch(PDO::FETCH_ASSOC)) {
                                                    ?>
                                                    <option <?php echo $soru['seviye_id'] == $row['seviye_id'] ? "selected" : null ?>
                                                            value="<?php echo $row['seviye_id'] ?>"><?php echo $row['seviye'] ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div id="_kategori">
                                            <select id="kategori" name="kategori" required="">
                                                ...
                                                while ($row = $kategori->fetch(PDO::FETCH_ASSOC)) {
                                                    ?>
                                                    <option <?php echo $soru['kategori_id'] == $row['kategori_id'] ? "selected" : null ?>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <button class="btn cyan waves-effect waves-light right" id="kaydet"
                                            type="submit" name="soruduzenle">Kaydet
    ...
    $(document).ready(function () {
        ...
        if ($("#durum").text().trim() == "ok") {
            swal({
                title: "Başarılı",
                type: "success",
                text: "Soru başarılı bir şekilde düzenlendi.",
