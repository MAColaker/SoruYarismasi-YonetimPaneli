                ...
                <table class="highlight">
                    ...
                    while ($row = $sorular->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr onclick='modal(<?php echo json_encode($sorucek[$index]); ?>,"<?php echo convertDate($sorucek[$index]['tarih']) ?>");'>
                            ...
                            <td><?php echo convertDate($sorucek[$index]['tarih']) ?></td>
...
<div id="modal0" class="modal">
    ...
    <div class="modal-footer">
        ...
        <a href="#!" id="duzenle"
           class="waves-effect waves-blue btn-flat modal-action modal-close blue-text">DÜZENLE</a>
        <form id="yayinla" action="../network/islem.php" method="POST">
            <input type="hidden" class="hide" id="durum" name="soru">
            <button type="submit" name="soruyayimla"
               class="waves-effect waves-green btn-flat modal-action modal-close green-text">YAYINLA</button>
        </form>
    </div>
</div>
