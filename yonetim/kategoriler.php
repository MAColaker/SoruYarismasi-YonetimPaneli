...
$kategori = $db->query("select * from kategori where kategori_id!=0", PDO::FETCH_OBJ)->fetchAll();
                        ...
                        <form action="../network/islem.php" method="POST">
                            ...
                            <div class="input-field">
                                <button class="btn waves-effect waves-light right"
                                        type="submit" name="kategoriekle">Ekle
            ...
            <div class="col l6" id="category">
                <div class="card" style="padding-left: 30px; padding-right: 30px; padding-bottom: 30px">
                    ...
                    <div class="dd" id="nestable3">
                        <?php
                        kategoriYazdirma(hiyerarsi($kategori))
                        ?>
