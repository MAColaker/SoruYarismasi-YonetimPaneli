...
$sorgu = $db->prepare("select * from yetki where yetki_id=:yetki_id");
$sorgu->execute(array(
    "yetki_id" => $id
));
                        ...
                        <form action="../network/islem.php" method="POST">
                            ...
                            <div class="input-field">
                                <input id="yetki" type="text" class="validate" name="yetki"
                                       value="<?php echo $yetki["yetki"] ?>">
                                <label for="yetki">Yetki İsmi</label>
                            </div>
                            <input class="hide" type="number" name="yetki_id"
                                   value="<?php echo $yetki['yetki_id'] ?>">
                            <div class="input-field">
                                <button class="btn waves-effect waves-light right"
                                        type="submit" name="yetkiduzenle">Düzenle
